...
public class ASRS {
	...
	public static final String STRING_RESERVATION = "Reservation";
	public static final String STRING_WALTING = "Waiting";
	public static final String STRING_HOLDING = "Holding";
	public static final String STRING_CONFIRMATION = "Confirmation";
	public static final String STRING_CANCELLATION = "Cancellation";
		
	public static final String STRING_FIRST_CLASS = "First";
	public static final String STRING_BUSSINESS_CLASS = "Bussiness";
	public static final String STRING_ECONOMIC_CLASS = "Economic";
