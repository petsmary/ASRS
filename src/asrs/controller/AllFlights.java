...
import asrs.model.Flight;
import asrs.model.FlightDetail;

public class AllFlights {

	static private asrs.db.JDBCDatabaseTable theFlights;
	static private asrs.db.JDBCDatabaseTable theFlightsDetails;
	...
	private AllFlights(String tableName1, String tableName2) {
		theFlights = new asrs.db.JDBCDatabaseTable(tableName1);
		theFlightsDetails = new asrs.db.JDBCDatabaseTable(tableName2);
	}
